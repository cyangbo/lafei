...
<body>
	...
	<!-- 标题栏 -->
        ...
        <h2><?php echo I('id')?'编辑':'新增';?>管理员</h2>
    </div>
	<!-- 修改密码表单 -->
	<form action="/admin.php?s=/admin/user/add_admin.html" method="post" class="form-horizontal">
		<input type="hidden" name="id" value="<?php echo I('id');?>">
		<div class="form-item">
			<label class="item-label">管理员名字：</label>
			<div class="controls">
				<input type="text" name="username" class="text input-large" <?=(I('id')?'readonly':'')?> autocomplete="off" value="<?php echo ($user['username']); ?>"/>
			</div>
		</div>
		<div class="form-item">
