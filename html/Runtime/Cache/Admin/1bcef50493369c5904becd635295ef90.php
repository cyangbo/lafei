...
<body>
	...
	<div class="search-form fr cf">
		<div class="sleft">
			...
			<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Action/actionlog');?>"><i class="btn-search"></i></a>
		</div>
	</div>
	<!-- 数据列表 -->
    ...
    <tbody>
		<?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><?php echo long2ip($vo['loginIP']);?></td>
...
$(function(){
    ...
    //导航高亮
    $('.side-sub-menu').find('a[href="<?php echo U('Action/actionlog');?>"]').closest('li').addClass('current');
})
</script>
