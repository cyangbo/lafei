...
<body>
	...
	<form action="<?php echo U('bank');?>" method="post">
		<div class="cf">
			<div class="fl">
			</div>
			...
			<div class="search-form fr cf">
				<div class="sleft">
					...
					<!-- <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('User/bank');?>"><i class="btn-search"></i></a> -->
				</div>
				<div class="sbtn">
    ...
    //导航高亮
    $('.side-sub-menu').find('a[href="<?php echo U('User/bank');?>"]').closest('li').addClass('current');
	</script>
