...
<body>
    ...
    <form action="/lafei/html/admin.php?s=/admin/score/addactivity.html" method="post" class="form-horizontal">
        <div class="form-item">
            <label class="item-label">消费总量<span class="check-tips">（达到多少消费总量赠送）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="all" value="">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">赠送金额<span class="check-tips"></span></label>
            <div class="controls">
    ...
    <script type="text/javascript">
        ...
        //导航高亮
        $('.side-sub-menu').find('a[href="<?php echo U('score/activity');?>"]').closest('li').addClass('current');
    </script>
