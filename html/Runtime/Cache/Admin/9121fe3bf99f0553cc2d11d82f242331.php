		...
		<div class="search-form fr cf">
			...
			<div class="sleft">
				<select style="width:120px;" name="liqType">
					...
					<?php if(is_array($liqTypeName)): $key = 0; $__LIST__ = $liqTypeName;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($key % 2 );++$key;?><option value="<?php echo ($key-1); ?>" title="<?php echo ($value); ?>"><?php echo ($value); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
