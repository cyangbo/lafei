...
<body>
    ...
    <form action="/lafei/html/admin.php?s=/admin/config/addbank.html" method="post" class="form-horizontal">
		<div class="form-item">
            <label class="item-label">银行名称<span class="check-tips"></span></label>
            <div class="controls">
				<select name="bankId">
					<?php if(is_array($bankList)): $i = 0; $__LIST__ = $bankList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
            </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            <label class="item-label">持卡人<span class="check-tips"></span></label>
            <div class="controls">
    ...
    <script type="text/javascript">
        //导航高亮
        $('.side-sub-menu').find('a[href="<?php echo U('Config/addBank');?>"]').closest('li').addClass('current');
    </script>
