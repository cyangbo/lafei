...
<div id="container" class="effect mainnav-fixed navbar-fixed footer-fixed mainnav-lg">
                            ...
                            <div class="clearfix">
                                ...
                                <div class="col-sm-4 col-md-3" id="menu_proxy">
                                    <ul class="list-unstyled">
                                        ...
                                        <li><a href="<?php echo U('team/report');?>" target="pageframe">消费报表</a></li>
                                        <li><a href="<?php echo U('team/record');?>" target="pageframe">投注记录</a></li>
                                        <li><a href="<?php echo U('team/coin');?>" target="pageframe">帐变明细</a></li>
	...
	<img alt="" src="/Public/Home/images/frame/av7.png"><span id="user_nickname" style="color:#515151;"><?php echo ($this->iff($user['nickname'],$user['nickname'],$user['username'])); ?></span>
	</a>
	</li>
	<li class="jifen"><img alt="" src="/Public/Home/images/frame/10.png">余额：<span id="user_sscmoney" style="color:red;"><?php echo ($user["coin"]); ?></span>元<span id="j-refresh" class="fa fa-refresh" action="<?php echo U('index/userinfo');?>" style="cursor:pointer;"></span></li>
	<li>
							...
							<strong>首页</strong>
                                ...
                                <li class="active">
                                    ...
                                    <ul aria-expanded="true" class="pop-in collapse in">
                                        <li><a href="<?php echo U('game/game?type=1&groupId=2');?>" target="pageframe">重庆时时彩<span class="pull-right badge badge-danger">热</span></a></li>
                                        <li><a href="<?php echo U('game/game?type=3&groupId=2');?>" target="pageframe">天津时时彩</a></li>
                                        <li><a href="<?php echo U('game/game?type=12&groupId=2');?>" target="pageframe">新疆时时彩</a></li>
                                        <li><a href="<?php echo U('game/game?type=36&groupId=2');?>" target="pageframe">秒秒彩<span class="pull-right badge badge-success">新</span></a></li>
                                        <li><a href="<?php echo U('game/game?type=5&groupId=2');?>" target="pageframe">分分彩<span class="pull-right badge badge-success">新</span></a></li>
                                        <li><a href="<?php echo U('game/game?type=34&groupId=2');?>" target="pageframe">二分彩<span class="pull-right badge badge-success">新</span></a></li>
                                        <li><a href="<?php echo U('game/game?type=14&groupId=2');?>" target="pageframe">五分彩<span class="pull-right badge badge-success">新</span></a></li>
                                        <li><a href="<?php echo U('game/game?type=35&groupId=2');?>" target="pageframe">韩国1.5分彩<span class="pull-right badge badge-success">新</span></a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a class="" title="" data-original-title="" href="#">
                                    ...
                                    <ul class="collapse pop-in">
                                        ...
                                        <li><a href="<?php echo U('game/game?type=16&groupId=10');?>" target="pageframe">江西11选5</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a class="" title="" data-original-title="" href="#">
                                    ...
                                    <ul class="collapse pop-in">
                                        <li><a href="<?php echo U('game/game?type=24&groupId=38');?>" target="pageframe">北京快乐8</a></li>
                                        <li><a href="<?php echo U('game/game?type=20&groupId=26');?>" target="pageframe">北京PK10</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a class="" title="" data-original-title="" href="#">
                                    ...
                                    <ul class="collapse pop-in">
                                        ...
                                        <li><a href="<?php echo U('game/game?type=10&groupId=12');?>" target="pageframe">排列三</a></li>
                                    </ul>
                                </li>
                                <li class="list-divider"></li>
...
<div class="sidemsg" id="chat_main">
    <div class="sidetitle">
        <img alt="" src="/Public/Home/images/frame/tx.jpg">会员昵称
        <span>
		<a href="javascript:void(0)" class="minimask" id="chat_mini">
		<img alt="" src="/Public/Home/images/frame/mini.png" title="最小化在线客服">
		</a>
		<a href="javascript:void(0)" class="closemask" id="chat_exit">
		<img alt="" src="/Public/Home/images/frame/cha.png" title="关闭在线客服">
		</a>
		</span>
    </div>
                    ...
                    <div class="list-group bg-trans renlist" id="renlist">
                        ...
                        <div class="list-group bg-trans">
                            ...
                            <a href="javascript:;" class="list-group-item" mark="xiaomi520" nick="上级" mode="superior" id="superior">
                                <div class="media-left">
                                    <img class="img-circle img-xs" src="/Public/Home/images/frame/av1.png" alt="Profile Picture" id="imgSupState">
                                </div>
                                <div class="media-body">
                                    <div class="text-lg">
                                        上级
