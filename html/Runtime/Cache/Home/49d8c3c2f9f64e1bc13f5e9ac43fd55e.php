...
<link href="/Public/Home/css/home.min.css" rel="stylesheet">
</head>
	...
	<div id="page-content" class="homecontainer">
		<div class="homerowa">
			...
			<div class="homerowamiddle">
				<div class="homebox">
					...
					<strong><img alt="" src="/Public/Home/images/main/r.png">本期奖池金额</strong>
				</div>
			</div>
			<div class="homemargin">
			</div>
		...
		<div class="homerowb">
			<div class="homerowbleft"  style="display: none">
				<div class="homebox">
					<div class="hometitle">
						<img alt="" src="/Public/Home/images/main/i1.png">安全等级<a>提升</a>
					</div>
					<div class="safebox">
				...
				<div class="homebox" style="margin-top: 20px;">
					<div class="hometitle">
						<img alt="" src="/Public/Home/images/main/i3.png">最近登录地址
			...
			<div class="homerowbright">
				<div class="homebox">
					<div class="hometitle">
						<img alt="" src="/Public/Home/images/main/i2.png">通知公告<a href="<?php echo U('notice/index');?>">更多</a>
					</div>
					<div class="hometipsbox">
						<div class="hometipsbox">
							<ul>
								...
								<li>
								<p>
									<img alt="" src="/Public/Home/images/main/a<?php echo ($ii); ?>.png">
                                        <?php echo ($var["title"]); ?>
...
<script src="/Public/Home/js/jquery.easypiechart.min.js"></script>
<script type="text/javascript">
        $(document).ready(function () {
