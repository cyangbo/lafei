...
<div class="effect mainnav-lg mainnav-fixed navbar-fixed footer-fixed" id="container">
	<div id="page-content">
		<div class="panel">
			<div class="mayhead">
				<p>
					<img alt="" src="/lafei/html/Public/Home/images/fei_game/tx.jpg"><strong><?php echo ($user["username"]); ?></strong>
				</p>
			</div>
			<div class="myinfo" id="myinfoa">
				<div class="myinfotitle">
					<span><img alt="" src="/lafei/html/Public/Home/images/main/d1.png">我的信息</span>
				</div>
				<div class="myinfotxt">
					<ul>
			...
			<div class="myinfo" id="myinfob">
				<div class="myinfotitle">
					<span><img alt="" src="/lafei/html/Public/Home/images/main/d2.png">团队信息</span>
				</div>
				<div class="myinfotxt">
					<ul>
			...
			<div class="myinfo" id="myinfoc">
				<div class="myinfotitle">
					<span><img alt="" src="/lafei/html/Public/Home/images/main/d3.png">其他信息</span>
				</div>
				<div class="myinfotxt">
					<ul>
						<li>绑定银行卡数量：<strong><?php echo ($this->iff($mybank,'0','1')); ?></strong></li>
					</ul>
				</div>
			</div>
		</div>
...
<script>        
        $('#updateNick').on('click', function () {
            ...
            $.ajax({
                type: "POST",
                url: '/lafei/html/index.php?s=/home/user/info.html',
